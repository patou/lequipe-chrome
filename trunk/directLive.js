			function displayDirect(item) {
				...
				switch(item['sport']) {
					case "FOOT":									
						html += loadDirectFoot(item); 	         
						break;
					case "TENNIS":									
						html += loadDirectTennis(item);             
						break;
					case "BASKET":									
						html += loadDirectBasket(item);           
						break;
					default: 
						html += '<div class="scx"> ';
						//  <div class="sc1">                    0                    </div>
			...
			function loadDirectBasket(item) {
			...
			function loadDirectTennis(item) {
